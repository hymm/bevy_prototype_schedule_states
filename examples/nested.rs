...
fn main() {
    App::new()
        ...
        .add_system_to_update(GameState::StartMenu, || println!("start"))
        .add_system_to_update(GameState::Playing, || println!("playing"))
        .add_system(
            driver::<GameState>
                .exclusive_system()
        ...
        .add_system_to_enter(PlayingState::Running, || println!("enter running"))
        .add_system_to_update(PlayingState::Running, || println!("running"))
        .add_system_to_exit(PlayingState::Running, || println!("exit running"))
        .add_system_to_enter(PlayingState::Paused, || println!("enter paused"))
        .add_system_to_update(PlayingState::Paused, || println!("paused"))
        .add_system_to_exit(PlayingState::Paused, || println!("exit paused"))
